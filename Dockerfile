#Reference: https://github.com/huggingface/transformers.js/blob/main/examples/next-server/Dockerfile
...
# Allow the running process to write Xenova model files to the cache folder.
